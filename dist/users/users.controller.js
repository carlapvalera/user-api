...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', required: true, description: 'ID del usuario a buscar', type: String }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', required: true, description: 'ID del usuario a actualizar', type: String }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', required: true, description: 'ID del usuario a eliminar', type: String }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
